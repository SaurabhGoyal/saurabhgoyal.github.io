...
So the basic idea was to write any small program in Assembly, but while doing that I learned a lot of the other things. [Check the post for detailed information on this]({% post_url 2019-06-02-program-in-assembly %}).
